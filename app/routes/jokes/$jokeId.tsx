...
import { DeleteJoke, GetJoke, Joke } from "~/utils/db.server";
...
export const loader: LoaderFunction = async ({ request, params }) => {
  ...
  console.log("getting joke", params.jokeId);
...
export default function JokeRoute() {
  ...
  console.log("Renreding joke route", data);
